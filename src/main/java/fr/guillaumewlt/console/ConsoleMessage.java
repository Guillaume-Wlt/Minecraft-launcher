package fr.guillaumewlt.console;

import fr.guillaumewlt.download.DownloadProgress;
...
public enum ConsoleMessage {
    ...
    /**
     * Create Message for {@link DirectoryCreatorUtils}<br>
    ...
    /**
     * Create Message for {@link ConstantUtils} <br>
    ...
    /**
     * Create Message for {@link DownloadProgress} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.directory.LauncherDirs} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.directory.LauncherDir} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.SelectedVersion} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.VersionRawData} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.ClientJarInfos} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.models.LibraryInfos} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.VersionJSONDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.ClientJarDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.LibrariesDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.AssetsIndexDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.AssetsObjectsDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.RuntimeJSONDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.JREManifestDownload} <br>
    ...
    /**
     * Create Message for {@link fr.guillaumewlt.download.JREFilesDownload} <br>
    ...
    /**
     * Create Message for {@link ClassPathBuildingProcess} <br>
    ...
    /**
     * Create Message for {@link RequestInfosProcess} <br>
