package fr.guillaumewlt.models.directory;

import fr.guillaumewlt.processing.steps.InitProcess;

import java.util.List;

/**
 * Groups all directories used by the launcher into a single immutable container.
 * Set by {@link InitProcess#process()},
...
public record LauncherDirs(
   ...
   LauncherDir runtimeDir
    ...
    public List<LauncherDir> getAllDirs() {
        return List.of(
                launcherDir,
                configDir,
                binDir,
